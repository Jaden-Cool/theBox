<template>
  <div>
    ...
    <div class="paragraph">
      ...
      <p class="normal">
        你大概知道为什么叫啪嗒仔，是因为那张矮凳放在地面上会啪嗒一声。鸾师妹长得不高，但是力气倒是很大，作为师父第一个招收的女弟子，平常总是需要更加小心翼翼。
      </p>
      <p class="normal">
        没有人知道她为什么对这张板凳那么情有独钟。但是没有这张板凳她根本就够不着案板。所以她在哪里板凳就会到哪里。这次小板凳失窃，恐怕又是一场莫须有的恶作剧。作为师父第一个招收的女弟子，所有人都不看好她。平常总是有些有心之人想把她用各种方法踢走。
      </p>
      <p class="normal">
        她在厨房做点心的时候，根本够不到灶台，便随身携带一张小凳子，宽大的裙摆刚好罩着凳子，使她看起来硬生生高大了一些。这次小板凳失窃，恐怕又是一场莫须有的恶作剧。
      </p>
      <p class="normal">
        “我睡醒起来之后就找不到了，会不会，就，师傅就不要我啦——”师妹几乎快哭出来了。
      </p>
      <p class="normal">
        你心里做好了最坏的打算，嘴里却说着“别急别急，还没开市，我和你去找。对了，冯沃师兄，他总是翻墙钻洞的，可能没问你就借去了也说不定。”你摸了摸师妹的乱头：“别哭了，不然你这阿鸾都要变成阿乱了。”
      </p>
    ...
    <div class="paragraph" @click="handleAutoPlay">
      ...
      <p class="normal">
        你难过的捂着耳朵，但是却无补于事。声音仿佛是一样穿透了手掌一样。这个低频的声音怎么那么...
        熟悉? 到底是哪里传来的....
      </p>
      <p class="normal">
        你放弃了抵抗，任由声音进入你的脑海。逐渐的，你在那宏大的鸣叫中听到了一段话。
      </p>
