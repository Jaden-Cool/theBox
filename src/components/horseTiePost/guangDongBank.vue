<template>
  <div>
    ...
    <div class="paragraph">
      <p class="normal">随着你把数字念出，黄符上一个字一个字的跟着亮了起来。思绪渐渐淡出，回到了当年。</p>
    </div>
    ...
    <div class="paragraph">
      ...
      <p class="normal">柜员在高高在上的柜台后面不停的跑动，我的内心也跟着他一起七上八下。此时，我眼角看到刘天师倚在门框上，拿着那张黄符在上面添了几笔。他总是在写这写那的，这种时候最好不要去打扰他。</p>
      <p class="normal">未曾等我反应过来，柜员打开了侧门，引领我走向那隐藏着父亲遗物的保险箱。</p>
    </div>

    <div class="paragraph">
      <p class="normal">回忆在打开保险柜之前的一刻中断了。仿佛这厚重的金属铁柜连来自未来的窥探都能挡住。</p>
      <p class="normal">这平安符上面，除了中间的那一列隐藏的密码，侧面和下方的那个符号... 好像是后加上去的。</p>
    </div>
