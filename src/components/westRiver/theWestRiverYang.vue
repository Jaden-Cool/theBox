    ...
    <div v-else>
      <div class="paragraph">
        ...
        <div style="margin: 26px 8px">
          ...
          但是，這些話你最後還是
          <p
            style="display: inline-block; padding: 0; margin: 0;text-align: center;"
            @click="next"
          >
            說了
          </p>
      ...
      <div class="paragraph">
        ...
        <p class="center"><strong>乒乒砰！</strong></p>
        <p class="normal">
          “暴露了！” 船上另外一名扒仔小聲喊道。那是下遊的遊擊隊與日軍發生了交火。常日昳心頭一緊，知道現在情況變得更加危險了。無論是不是遊擊隊爲了他們行動做的掩護，根據事前的部署，他們如今該做的就是全力前進，帶孩子們盡快離開戰鬥區域。
        </p>
        <p class="normal">
          妳咬緊牙關，拼盡全力推動船槳把船扒過了江的一半。這艘超載的假漁船在江裏逆流而上， “我們不能錯過彙合地點！對岸的纖夫兄弟們等著我們呢。錯過他們的話我們就上不了岸了！ 飄到下遊會被打成篩子的！” 妳低聲喊。船速陡然加快，水花在船邊濺起。孩子們雖然害怕，但也明白情況危急，都緊緊抱在一起，互相捂著對方嘴巴。
        </p>
        <p class="normal">
          槍聲漸遠，筋疲力竭的大家終于靠近了對岸。但是並沒見到原本應該出現的纖夫。難道……
        </p>
        <p class="normal">
          妳來不及細想，妳搖槳的雙手已經在發抖，這麽下去不是辦法！ 妳拿著纜繩一頭栽進了樹叢裏，胡亂地用纜繩綁住了一顆樹，好不容易終于把船固定好了。妳和幾個扒仔迅速地抱孩子們下船，孩子們有的已經開始了哭鬧，妳看見了之前哭鬧的蔡爾洪，他反而很懂事地先推別的孩子下船，把自己留在了最後。
        </p>
        <p class="center"><strong>咻咻— </strong></p>
        ...
        <p class="normal">
          現在只要松開纜繩，自己和另外一個船夫就可以原路回去了。江邊這一段都是安全區，江上沒有日軍的船只。 “順流而下，他們怎麽都追不上的。” 妳開始嘗試解開纜繩。
        </p>
        <p class="normal">
