  ...
  <div>
    ...
    <div class="paragraph">
      ...
      <div style="width: 300px; margin: 0 auto">
        ...
        <p style="margin: 0 0 26px 0" class="subtleFade" @click="isNeedTimer = !isNeedTimer">
          是否需要我来帮你计时？{{ isNeedTimer ? 'YES!' : 'NO!' }}
        </p>
      </div>
    </div>
    ...
    <div v-show="isStart" class="paragraph">
      <p class="normal">
        随着午未和红荔之间的关系日益亲密，白驹班里的成员们也渐渐察觉到了这段爱情的萌芽。文武生和花旦们护妹心切，一番讨论过后他们一致认为，午未这个根本还没入行的木匠根本就配不上红荔。
      </p>

      <p class="normal">
        他们推选出了艺名为靓少凤的班长，<strong>罗叔铭</strong>，给午未下了一封“战书”，好让这个男人识相离开他们的掌上明珠。为了保证午未会输，又不至于显得他们过于欺负人，戏班选择了一项传统的戏班技巧比拼——“起单脚”。
      </p>
      ...
      <p class="center">
        <van-image
          fit="contain"
          :src="shuMingLuo"
          @click="showImagePreview({ images: [shuMingLuo], showIndex: false })"
        />
      </p>

      <p class="normal">
        “起单脚”
        出自《罗成写书》，是一项考验平衡力和耐力的技巧。这是戏班的武生们都需要练的功，是最简单也是最难的功夫。常午未对这项技艺并不熟悉，但是为了证明自己对红荔的真心，午未接受了挑战。
      </p>

      <p class="normal">但是为了证明自己对红荔的真心，午未接受了挑战。</p>

      <p class="normal">
        挑战当天选在端午节，村子里张灯结彩，好不热闹。白驹班的成员故意挑了这一天，让午未错过自己一年一度的木匠考核。午未暗骂他们卑鄙，但却又无可奈何。
      </p>
      ...
      <p class="normal">
        两个人爬到木桩上面，像两个武林高手一般，一脸严肃地看着对方。下面观众的情绪也被调动了起来，开始起哄。
      </p>

      <p class="normal">
        靓少凤转身面向观众大声说道：“要是你今天输了，你以后就要和红荔断绝关系。”
        还没等常午未回答，他就转身向着看戏的众人喊道：“在座各位都是我靓少凤的见证人！我们事不宜迟。奏乐！开始！”
      </p>
      ...
      <p class="normal">
        就在此时，白驹班和人潮被几个肌肉猛男推开。从人群中走出的人竟然是“金眼风“黄师傅。他身后带着一大堆徒弟，少说也有五六十人。走在后面的几个人架起了锣鼓开始猛烈的擂锣，打着龙船冲刺的鼓点，音浪和白驹班这边分庭抗礼。
      </p>

      <p class="normal">
        黄师傅嘴里叼着一支长烟，吞云吐雾的走在队伍最前方，用嘴里的烟续上了第二根香，竟然向着靓少凤隔空拜了一拜，“罗班长！小心你的老腿呀~”
        靓少凤气的一阵摇晃，差点从木桩上掉落下来。
      </p>

      <p class="normal">
        接着黄师傅对着午未大喊，“妖！今日我连龙船都不去看，专门来看你这个衰仔（混小子），米映衰（丢脸）我地堂口啊！如果你赢到呢条花靚仔（这个老油条）——我破格收你做徒弟！”
      </p>
      ...
      <p class="normal">
        所有人大气都不敢喘的看着，生怕一口气就会把其中一人吹倒。常午未满脸通红的咬紧牙关，靓少凤这边则是面如金纸嘴唇发紫。这场比赛陷入了焦灼。
      </p>

      <p class="normal">
        此时，人群后面传来了骚动，只见突然有一颗红色的异物飞出，正正的打在了靓少凤的头上。靓少凤一惊，脚下一乱马上失去了平衡。
      </p>
      ...
      <p class="normal">
        只见红荔一袭红衣，气喘吁吁地出现在了人群之后。她身上的衣服有曾被拉扯的痕迹，脚上仅剩一只绣花鞋，披头散发气势汹汹，所有人都自觉地慢慢让出一条路。
      </p>

      <p class="normal">她远远看到台上一人影倒下，谁也没看到赶来的她眼中那一抹焦急的泪花。</p>

      <p class="normal">
        午未看到对手被砸倒，心中一松，也虚下力来倒了下去。红荔心中祈祷着，因为她也是看着模模糊糊的身影出手，没有十足把握不误伤所爱之人，但她也有些许自信，因为有个身影已经烙印在她脑海里，就算模糊，也不会忘记。
      </p>
      ...
      <p class="normal">
        “但我心里从没感觉到缺损，白驹班里的每个人都那么像我的亲人，有视我如己出的长辈，有待我如亲妹的兄弟们。我和你们一日三餐都一起吃，大家都爱我，想保护我。生活所迫下，我们都做过许多自己不愿意的选择，有困难你们都很照顾我。但是唯独这一件事……”
      </p>

      <p class="normal">
        说到这里她顿了一下，高昂的语气慢慢降了下来，但每个字都坚决有力：“我不能妥协！”
      </p>

      <p class="normal">
        她的脸已经红透了，“戏班之中，我也见识了许多人生别离的故事，人情冷暖，有情人许多无法成眷属，有的来自父母的阻碍，有的来自人间的困扰，或者说家族、利益，都会给一段良缘立下许多阻碍，佳话总难成，斗争总会有。可我觉得我在戏班中，体会到的和戏中不同，日子虽然艰苦，但我从没感觉大家心中没有热枕，没有憧憬，对美好没有期待。”
      </p>

      <p class="normal">白驹班的成员们彼此对视，心中多少有些感触。</p>

      <p class="normal">
        “这个男人他肯为我拼命，我也感动，我也心疼，我希望大家能祝福我们，让我们两个这台戏，能成一段佳话。”
      </p>

      <p class="normal">
        台下，戏班众人陷入了短暂的沉默，他们不是不想回应，而是后面缓缓站起身的靓少凤吸引力大家注意力。
      </p>

      <p class="normal">
        靓少凤头有些晕晕的，双掌刚好搭在午未肩膀上，低下的头缓缓抬起，眼睛里还有些血丝，看似恶狠狠的眼神却说出了让红荔安心的话语：“好吧，常午未，我代表我们白驹班认你这个人。你要好好对待红荔，要是有什么闪失我们几十个人一人拆你一条狗腿。”
      </p>

      <p class="normal">
        轰——台下的戏班众人听到这话都一拥而上，有关照班长的，有关照师妹的，也有几个爱看热闹的在关心常午未，七嘴八舌他听得不太清楚，大概意思都是羡慕他的。
      </p>
