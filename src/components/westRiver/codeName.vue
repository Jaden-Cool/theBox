<template>
    <div>
      ...
      <div class="paragraph">
        <p class="normal">
            “非常好。” 赵百则把子弹退了膛，才从树影中走了出来。“你们迟了足足一个小时你知道吗？有几个人都以为你们遇难了。吓死我了。来，赶紧进村。给你们热点吃的，都饿了吧？来，泡泡脚，天亮了还得走上几天呢。我们以后就是同事了。我叫赵百则，一百则书的百，一百则书的则。”
        </p>
        <p class="normal">
        ...
        <p class="normal">接下来的几天，他们走村串巷，依靠当地村民的接应和帮助，才得以顺利前行。每到一个村庄，村民们总是热情地招待他们，为孩子们提供食物和温暖的住所。</p>
        <p class="normal">
