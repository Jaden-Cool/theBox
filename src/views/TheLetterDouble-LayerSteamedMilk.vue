<template>
  ...
  <div>
    <div class="paragraph">
      ...
      <p class="normal">
        董孝华每次问完日昳的来头，就埋头干活不再理他。相信这一次也不例外。不过，不用在厨房处理材料，日昳也是䟴䟴脚，滋滋悠。
      </p>
      <p class="normal">
      ...
      <p class="normal">
        小姐姐端出一个蓝色瓷碗：“这是我们的新产品，水牛奶加热放凉之后会产生奶皮，也能存放更久些。我加了蛋白和砂糖进去炖，然后就会凝固了，我想这样应该更容易卖。”
      </p>
      <p class="normal">
        日昳不知道，他竟是这日后鼎鼎大名的双皮奶的第一拨客人。吃了两口以后只觉得水牛奶的奶腥气完全被白糖压住了，顺滑的口感重新带出了奶香。日昳闭着眼享受着余韵的时候，
      </p>
      <p class="normal">
    ...
    <div class="paragraph">
      <p class="normal">
        回到现实，你也有了些许疲惫，手中<strong>握着盒子中的一角钱，行至仁信双皮奶店内，没想到用这老旧的一角钱真的换到了一碗水牛奶</strong>。店里的店员貌似对这张一角钱都有一种默契。
      </p>
    </div>

    <div class="paragraph">
      <p class="center">
        【抬头看见了周围墙上有些古老的物件，联想到回忆中生产水牛奶的两个避忌之处，把他们去除之后，数了数剩下物品的数量。】
      </p>
